/*使用说明：
	cBanner({
		...
		sliderItem: 'c_slider_item', //圆圈列表Id，选填
...
window.onresize = function() {
	...
	c_slider_list.style.width = pieceW * piece.length + "px";

	for(var i = 0; i < piece.length; i++) {
		piece[i].style.width = pieceW + "px";
	}

	c_slider_list.style.transition = "";
	c_slider_list.style.left = -clearPoint.index * pieceW + "px";
